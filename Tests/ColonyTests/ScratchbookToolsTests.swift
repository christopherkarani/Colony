...
@Test("Scratchbook tools are not advertised without ColonyAgentCapabilities.scratchbook")
...
@Test("Scratchbook tools are advertised when ColonyAgentCapabilities.scratchbook is enabled")
...
@Test("Scratchbook tool execution rejects calls when ColonyAgentCapabilities.scratchbook is disabled")
