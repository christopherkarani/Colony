...
`ColonyBootstrap` is the default public entrypoint. `ColonyAgentFactory` remains available for lower-level assembly, but the full runtime stack now comes through bootstrap.
