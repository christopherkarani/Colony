...
public struct ColonyAgentFactory: Sendable {
    private static let conversationHistoryPath = ColonyVirtualPath.trustedConstantPath("/conversation_history")
    private static let scratchbookPath = ColonyVirtualPath.trustedConstantPath("/scratchbook")
